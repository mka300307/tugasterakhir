...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Dokter</a>
    <div class="dropdown pd-4">
        ...
        <ul class="dropdown-menu dropdown-menu-white">
            <li>
                <form method="POST" action="/logout">
                    @csrf
                    <button class="dropdown-item text-danger" type="submit"><i class="fa-solid fa-right-from-bracket"></i> Log out</button>
                </form>
            </li>
        </ul>
    </div>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                @foreach ($spesial as $item)
                    <tr>
                        ...
                        <td>{{ $item['nama'] }}</td>
                        <td>
                            <a href="/spesial/edit/{{ $item->id }}" class="btn btn-warning">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Yakin ingin menghapus Spesialis {{ $item->nama }}
                                    </div>
